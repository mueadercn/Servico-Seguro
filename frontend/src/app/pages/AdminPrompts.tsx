...
const CATEGORIAS_PROMPTS = [
  ...
  { chave: 'system_prompt_eletrica', label: 'Elétrica / Instalações', icone: '⚡', desc: 'Problemas elétricos, quadro de disjuntores, pontos' },
  ...
  { chave: 'system_prompt_pintura', label: 'Pintura', icone: '🎨', desc: 'Pintura interna, externa, massa corrida, textura' },
  { chave: 'system_prompt_construcao', label: 'Construção e Reforma', icone: '🏗️', desc: 'Obras, reforma, alvenaria, ampliação' },
  { chave: 'system_prompt_acabamentos', label: 'Acabamentos', icone: '🧱', desc: 'Revestimentos, piso, rejunte, rodapé, texturas' },
  { chave: 'system_prompt_marcenaria', label: 'Marcenaria e Móveis', icone: '🪵', desc: 'Móveis planejados, armários, bancadas, reparos' },
  { chave: 'system_prompt_serralheria', label: 'Serralheria', icone: '🔩', desc: 'Portões, grades, estruturas metálicas, guarda-corpo' },
  { chave: 'system_prompt_vidros', label: 'Vidros e Esquadrias', icone: '🪟', desc: 'Box, janelas, portas de vidro, espelhos' },
  { chave: 'system_prompt_seguranca', label: 'Segurança', icone: '🔐', desc: 'Câmeras, alarmes, controle de acesso, cerca elétrica' },
  { chave: 'system_prompt_tecnologia', label: 'Tecnologia', icone: '💻', desc: 'Redes, suporte técnico, automação, câmeras IP' },
  { chave: 'system_prompt_limpeza', label: 'Limpeza e Conservação', icone: '🧹', desc: 'Limpeza residencial, pós-obra, dedetização, fossa' },
  { chave: 'system_prompt_jardinagem', label: 'Jardinagem e Paisagismo', icone: '🌳', desc: 'Poda, paisagismo, manutenção, plantio, irrigação' },
  { chave: 'system_prompt_piscinas', label: 'Piscinas e Áreas Externas', icone: '🏊', desc: 'Limpeza, manutenção, reforma, deck, área gourmet' },
  { chave: 'system_prompt_fretes', label: 'Fretes e Mudanças', icone: '🚚', desc: 'Mudanças, fretes, carretos, montagem de móveis' },
  { chave: 'system_prompt_automotivo', label: 'Serviços Automotivos', icone: '🚗', desc: 'Mecânica, elétrica veicular, funilaria, higienização' },
  { chave: 'system_prompt_pets', label: 'Pets', icone: '🐾', desc: 'Banho, tosa, veterinário, adestramento, hospedagem' },
  { chave: 'system_prompt_saude', label: 'Saúde e Bem-Estar', icone: '💪', desc: 'Fisioterapia, personal, nutrição, massagem, estética' },
  { chave: 'system_prompt_educacao', label: 'Educação', icone: '📚', desc: 'Aulas particulares, reforço, idiomas, música' },
  { chave: 'system_prompt_eventos', label: 'Eventos e Experiências', icone: '🎉', desc: 'Festas, casamentos, fotografia, DJ, animação' },
  { chave: 'system_prompt_locacoes', label: 'Locações', icone: '🏠', desc: 'Imóveis, equipamentos, estruturas para eventos' },
  { chave: 'system_prompt_empresarial', label: 'Serviços Empresariais', icone: '🏢', desc: 'Manutenção comercial, consultoria, infraestrutura' },
  { chave: 'system_prompt_rural', label: 'Serviços Rurais', icone: '🚜', desc: 'Terraplanagem, cercas, irrigação, plantio' },
  { chave: 'system_prompt_predial', label: 'Manutenção Predial e Condomínios', icone: '🏘️', desc: 'Zeladoria, reparos, áreas comuns, portões' },
];
